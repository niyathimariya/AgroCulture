...
include("login.php");
echo "<br>";
$query1="select * from crop where Local_Name='Cauliflower'";
$result = mysqli_query($con,$query1);
$_SESSION["veggie"]="Cauliflower";
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
cursor: grab;
    ...
    <link rel="stylesheet" href="/ProjectDemo/css/caulicss.css">
</head>
<body>
   <h1><b>CAULIFLOWER</b></h1>
    <table>
        <thead>
            <tr>
