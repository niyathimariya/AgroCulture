...
include("login.php");
echo "<br>";
$query1="select * from crop where Local_Name='Ladiesfinger'";
$result = mysqli_query($con,$query1);
$_SESSION["veggie"]="Ladiesfinger";
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
cursor: grab;
    ...
    <link rel="stylesheet" href="/ProjectDemo/css/ladysfingercss.css">
</head>
<body>
   <h1><b>LADIESFINGER</b></h1>
    <table>
        <thead>
            <tr>
